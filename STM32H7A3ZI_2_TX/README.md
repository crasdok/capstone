...
```
> * 함수 내부에서 htim->Channel 값에 따라 다른 채널의 입력 캡처 인터럽트를 처리합니다.
> * Is_First_Captured_x 변수는 각 채널의 첫 번째 캡처 값이 캡처되었는지 여부를 나타냅니다.
> * 최초로 캡처되지 않은 경우, IC_Val1_1에 첫 번째 값을 저장하고 캡처가 되었음을 표시하며, 캡처를 하강 에지로 설정합니다.
> * 이미 첫 번째 캡처가 된 경우, 두 번째 값을 IC_Val2_1에 저장하고 타이머 카운터를 초기화합니다.
> * IC_Val2_1과 IC_Val1_1의 크기에 따라 두 값의 차이를 계산합니다.
